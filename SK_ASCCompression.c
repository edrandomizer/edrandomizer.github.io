...
//Full credit to: https://github.com/jombo23/N64-Tools

void WriteLongToBuffer(unsigned char* Buffer, unsigned int address, unsigned int data)
{
...
void WriteShortToBuffer(unsigned char* Buffer, unsigned int address, unsigned short data)
{
	address = address & 0xFFFFFFF;
...
void WriteCharToBuffer(unsigned char* Buffer, unsigned int address, unsigned short data)
{
	address = address & 0xFFFFFFF;
...
unsigned int CharArrayToLong(unsigned char* currentSpot)
{
	return ((((((currentSpot[0] << 8) | currentSpot[1]) << 8) | currentSpot[2]) << 8) | currentSpot[3]);
}

unsigned int CharArrayToByte(unsigned char* currentSpot)
{
	return currentSpot[0];
}
*/
unsigned short CharArrayToShort(unsigned char* Buffer, unsigned int address)
{
	address = address & 0xFFFFFFF;
...
unsigned int CharArrayToLong(unsigned char* Buffer, unsigned int address)
{
	address = address & 0xFFFFFFF;
	
	unsigned int ret=Buffer[address + 0];
	ret=(ret << 8) | Buffer[address +1];
	ret=(ret << 8) | Buffer[address +2];
	ret=(ret << 8) | Buffer[address +3];

	return ret;

	//return (((unsigned int)((((Buffer[address + 0] << 8) | Buffer[address + 1]) << 8) | Buffer[address + 2]) << 8) | Buffer[address + 3]);
}

unsigned int CharArrayToChar(unsigned char* Buffer, unsigned int address)
{
	address = address & 0xFFFFFFF;
...

{
  ...
  if ((int)CharArrayToLong(RAM, param_1 + 0x2000) != 0) {
	unsigned int functionPointer = CharArrayToLong(RAM, (param_1 + 0x2ad0));
...
void FUN_80145774(unsigned char* RAM, int param_1,int param_2,int param_3,short param_4,int param_5)
{
  ...
  if ((int)(unsigned int)(short)CharArrayToShort(RAM, param_1 + 2) < param_3) {
    return;
  }
  iVar8 = param_2 * 2 + -1;
  ...
  if (param_2 <= iVar8) {
    do {
      if (1 < CharArrayToShort(RAM, puVar5Offset)) {
        WriteShortToBuffer(RAM, puVar5Offset, (unsigned short)((int)(unsigned int)CharArrayToShort(RAM, puVar5Offset) >> 1));
      }
...
/*unsigned _int64 CONCAT44(unsigned int a, unsigned int b)
{
...
unsigned int FUN_8020d318(unsigned char* RAM, int param_1, int param_2Offset, unsigned int param_3)
...
unsigned int FUN_8015cffc(unsigned char* RAM, int param_1, unsigned int param_2, int param_3)
{
  unsigned int uVar1;
  unsigned int uVar2;
  int iVar3;
  ...
  if ((int)CharArrayToLong(RAM, (param_3 + 0x2050)) == 1) {
    ...
    do {
      ...
      iVar3 = iVar3 + uVar2;
      WriteLongToBuffer(RAM, (param_3 + 0x2054), (unsigned int)((int)CharArrayToLong(RAM, param_3 + 0x2054) + uVar2));
      WriteLongToBuffer(RAM, (param_3 + 0x2058), (unsigned int)((int)CharArrayToLong(RAM, param_3 + 0x2058) - uVar2));
      WriteLongToBuffer(RAM, (param_3 + 0x207c), (unsigned int)((int)CharArrayToLong(RAM, param_3 + 0x207c) - uVar2));
      if ((int)CharArrayToLong(RAM, (param_3 + 0x2058)) == 0) {
...
void FUN_800051bc(unsigned char* RAM, int param_1, unsigned int param_2, unsigned int param_3)

{
  ...
  if (0x1f < param_3) {
    uVar1 = ~(unsigned int)puVar3Offset & 3;
    if (uVar1 != 0) {
...
unsigned int FUN_8000518c(unsigned char* RAM, int param_1, unsigned int param_2, unsigned int param_3)
...

{
  ...
  unsigned int functionPointer = CharArrayToLong(RAM, (param_1 + 0x2ad4));
...
void FUN_80145e60(unsigned char* RAM, int param_1, unsigned int param_2, unsigned int param_3)
...
void FUN_80145e6c(unsigned char* RAM, int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4,
...
unsigned int FUN_80146110(unsigned char* RAM, unsigned char* compressedFile, unsigned int compressedFileSize, unsigned int param_1, unsigned int outputAddress, void ** output)
{
  ...
  int outputAlloc=0x1000;
  *output=malloc(outputAlloc);
  ...
  do {
    while( 1 ) {
        ...
        if ((uVar8 & 0xfe) == 0) {
          if ((int)CharArrayToLong(RAM, param_1 + 0x2000) < 1) {
            ...
            if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
              ...
              uVar8 = (unsigned int)CharArrayToChar(RAM, param_1 + iVar4);
            }
          }
          else {
            WriteLongToBuffer(RAM, (param_1 + 0x2000), (int)((int)CharArrayToLong(RAM, param_1 + 0x2000) + -1));
      ...
      if (5999 < uVar13) {
        WriteShortToBuffer(RAM, (iVar15 + 0xa40), (short)((int)(unsigned int)CharArrayToShort(RAM, iVar15 + 0xa40) >> 1));
        if (CharArrayToShort(RAM, iVar15 + 0xa40) == 0) {
          WriteShortToBuffer(RAM, (iVar15 + 0xa40), 1);
        }
        WriteShortToBuffer(RAM, (iVar15 + 0xa42), (short)((int)(unsigned int)CharArrayToShort(RAM, iVar15 + 0xa42) >> 1));
        if (CharArrayToShort(RAM, iVar15 + 0xa42) == 0) {
          WriteShortToBuffer(RAM, (iVar15 + 0xa42), 1);
        }
      }
      uVar6  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c);
      uVar16 = (uVar16 & 1) << 1;
      uVar17  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x2018);
      uVar11  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x226a);
      ...
      if (iVar10 < (int)uVar11) {
        ...
        iVar15 = 0;
        while( 1 ) {
          uVar6  = (unsigned int)CharArrayToShort(RAM, iVar20 + iVar7 * 2 + 0x240);
        ...
        uVar5 = iVar7 - 0x100;
        uVar17  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c);
        uVar11  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x2018);
        iVar7 = (CharArrayToShort(RAM, param_1 + 0x201a) - uVar17) + 1;
        uVar6 = CharArrayToLong(RAM, param_1 + 0x2020);
        uVar13 = ((int)(iVar7 * (iVar15 + (unsigned int)CharArrayToShort(RAM, iVar20 + uVar5 * 2 + 0x440))) / iVar4 +
                 uVar17) - 1;
          ...
          if ((uVar6 & 0xfe) == 0) {
            if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
              ...
              if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
                ...
                iVar4 = (int)CharArrayToLong(RAM, param_1 + 0x2004);
                WriteLongToBuffer(RAM, (param_1 + 0x2004), (int)(iVar4 + 1));
                uVar6 = (unsigned int)CharArrayToChar(RAM, param_1 + iVar4);
              }
            }
            else {
              WriteLongToBuffer(RAM, (param_1 + 0x2000), (int)((int)CharArrayToLong(RAM, param_1 + 0x2000) + -1));
          ...
          if ((uVar13 & 0xfe) == 0) {
            if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
              ...
              if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
                ...
                iVar4 = (int)CharArrayToLong(RAM, param_1 + 0x2004);
                WriteLongToBuffer(RAM, (param_1 + 0x2004), (int)(iVar4 + 1));
                uVar11 = (unsigned int)CharArrayToChar(RAM, param_1 + iVar4);
              }
            }
            else {
              WriteLongToBuffer(RAM, (param_1 + 0x2000), (int)((int)CharArrayToLong(RAM, param_1 + 0x2000) + -1));
          ...
          if ((uVar13 & 0xfe) == 0) {
            if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
              ...
              if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
                ...
                iVar4 = (int)CharArrayToLong(RAM, param_1 + 0x2004);
                WriteLongToBuffer(RAM, (param_1 + 0x2004), (int)(iVar4 + 1));
                uVar13 = (unsigned int)CharArrayToChar(RAM, param_1 + iVar4);
              }
            }
            else {
              WriteLongToBuffer(RAM, (param_1 + 0x2000), (int)((int)CharArrayToLong(RAM, param_1 + 0x2000) + -1));
		...
		// off here
        uVar6  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x266a);
        while( 1 ) {
          uVar17  = (unsigned int)CharArrayToShort(RAM, iVar20 + iVar4 * 2 + 0x640);
          if ((int)(iVar7 + uVar17) <=
              (int)(uVar6 * (((unsigned int)CharArrayToShort(RAM, param_1 + 0x2018) -
                             (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c)) + 1) + -1) /
              (int)(((unsigned int)CharArrayToShort(RAM, param_1 + 0x201a) - (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c)) + 1)
             ) {
            iVar7 = iVar7 + uVar17;
            iVar4 = iVar4 + 1;
          }
        ...
        uVar11  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c);
        uVar13  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x2018);
        iVar10 = (CharArrayToShort(RAM, param_1 + 0x201a) - uVar11) + 1;
        uVar17 = CharArrayToLong(RAM, param_1 + 0x2020);
        uVar8 = ((int)(iVar10 * (iVar7 + (unsigned int)CharArrayToShort(RAM, iVar20 + uVar5 * 2 + 0x840))) /
                 (int)uVar6 + uVar11) - 1;
          ...
          if ((uVar17 & 0xfe) == 0) {
            if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
              ...
              if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
                ...
                uVar6 = (unsigned int)CharArrayToChar(RAM, param_1 + iVar7);
              }
            }
            else {
              WriteLongToBuffer(RAM, (param_1 + 0x2000), (int)((int)CharArrayToLong(RAM, param_1 + 0x2000) + -1));
          ...
          if ((uVar17 & 0xfe) == 0) {
            if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
              ...
              if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
                ...
                iVar7 = (int)CharArrayToLong(RAM, param_1 + 0x2004);
                WriteLongToBuffer(RAM, (param_1 + 0x2004), (int)(iVar7 + 1));
                uVar17 = (unsigned int)CharArrayToChar(RAM, param_1 + iVar7);
              }
            }
            else {
              WriteLongToBuffer(RAM, (param_1 + 0x2000), (int)((int)CharArrayToLong(RAM, param_1 + 0x2000) + -1));
        ...
        uVar6 = iVar4 - 0x108U & ~-((unsigned int)(uVar5 < 8) - ((int)uVar5 >> 0x1f));
      ...
      if (iVar4 == (int)CharArrayToLong(RAM, param_1 + 0x2a9c)) {
		...
		//sizeOutputFile = GetSizeFile(outputFilename);
		int extraOffset = 0;
		if (sizeOutputFile == 0)
			extraOffset = 4;
        ...
        //fflush(out2);
		//fclose(out2);
		while(sizeOutputFile+iVar4-extraOffset>=outputAlloc){
			outputAlloc*=2;
			*output=realloc(*output, outputAlloc);
		}

		memcpy(((char*)(*output))+sizeOutputFile, &RAM[((int)CharArrayToLong(RAM, param_1 + 0x2ac8) & 0xFFFFFFF) + extraOffset], iVar4 - extraOffset);
		
		sizeOutputFile+=iVar4-extraOffset;
      }
      if (iVar19 < 0x79e0) {
        iVar19 = iVar19 + 1;
      }
    ...
    if ((int)uVar13 <= iVar7) {
        ...
        if ((uVar16 & 0xfe) == 0) {
          if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
            ...
            if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
              ...
              uVar16 = (unsigned int)CharArrayToChar(RAM, param_1 + iVar19);
            }
          }
          else {
            WriteLongToBuffer(RAM, (param_1 + 0x2000), (int)((int)CharArrayToLong(RAM, param_1 + 0x2000) + -1));
	  ...
	  //fclose(out);
	   ...
	   // int sizeOutputFile = GetSizeFile(outputFilename);
		...
		while(sizeOutputFile+last-extraOffset>=outputAlloc){
			outputAlloc*=2;
			*output=realloc(*output, outputAlloc);
		}
		
		memcpy(((char*)(*output))+sizeOutputFile, &RAM[((int)CharArrayToLong(RAM, param_1 + 0x2ac8) & 0xFFFFFFF) + extraOffset], last - extraOffset);
		
		sizeOutputFile+=last-extraOffset;
    ...
    if (5999 < uVar13) {
      WriteShortToBuffer(RAM, (iVar15 + 0xa40), (short)((short)((int)(unsigned int)CharArrayToShort(RAM, iVar15 + 0xa40) >> 1)));
      if (CharArrayToShort(RAM, iVar15 + 0xa40) == 0) {
        WriteShortToBuffer(RAM, (iVar15 + 0xa40), 1);
      }
      WriteShortToBuffer(RAM, (iVar15 + 0xa42), (short)((short)((int)(unsigned int)CharArrayToShort(RAM, iVar15 + 0xa42) >> 1)));
      if (CharArrayToShort(RAM, iVar15 + 0xa42) == 0) {
        WriteShortToBuffer(RAM, (iVar15 + 0xa42), 1);
      }
    }
    ...
    while ((int)(CharArrayToLong(RAM, param_1 + 0x2a7c)) < iVar19) {
	  unsigned int R7 = (int)CharArrayToLong(RAM, param_1 + 0x2a80);
    ...
    iVar4 = 2;
    iVar7 = 0;
    uVar6  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x222a);
    while( 1 ) {
      uVar17  = (unsigned int)CharArrayToShort(RAM, iVar20 + iVar4 * 2 + 0x200);
      if ((int)(iVar7 + uVar17) <=
          (int)(uVar6 * (((unsigned int)CharArrayToShort(RAM, param_1 + 0x2018) - (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c))
                        + 1) + -1) /
          (int)(((unsigned int)CharArrayToShort(RAM, param_1 + 0x201a) - (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c)) + 1)) {
        iVar7 = iVar7 + uVar17;
        iVar4 = iVar4 + 1;
    ...
    uVar17 = CharArrayToLong(RAM, param_1 + 0x2020);
    uVar8 = ((int)(iVar4 * (iVar7 + (unsigned int)CharArrayToShort(RAM, iVar20 + uVar5 * 2 + 0x220))) / (int)uVar6 +
            uVar11) - 1;
      ...
      if ((uVar17 & 0xfe) == 0) {
        if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
          ...
          if (CharArrayToLong(RAM, (int)param_1 + 0x2000) < 1) {
            ...
            iVar4 = (int)CharArrayToLong(RAM, param_1 + 0x2004);
            WriteLongToBuffer(RAM, (param_1 + 0x2004), (int)(iVar4 + 1));
            uVar17 = (unsigned int)CharArrayToChar(RAM, param_1 + iVar4);
          }
        }
        else {
          WriteLongToBuffer(RAM, (param_1 + 0x2000), (int)((int)CharArrayToLong(RAM, param_1 + 0x2000) + -1));
...
LAB_80147020:
    ...
    uVar6  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c);
    uVar17  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x2018);
    uVar11  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x202a);
    ...
    if (iVar10 < (int)uVar11) {
      ...
      iVar15 = 0;
      while( 1 ) {
        uVar6  = (unsigned int)CharArrayToShort(RAM, iVar20 + iVar7 * 2);
        if ((int)(iVar15 + uVar6) <= iVar10) {
          iVar15 = iVar15 + uVar6;
          iVar7 = iVar7 + 1;
        }
      ...
      iVar7 = (CharArrayToShort(RAM, param_1 + 0x201a) - uVar17) + 1;
      uVar6 = CharArrayToLong(RAM, param_1 + 0x2020);
      uVar13 = ((int)(iVar7 * (iVar15 + (unsigned int)CharArrayToShort(RAM, iVar20 + uVar14 * 2 + 0x80))) / iVar4 +
               uVar17) - 1;
      uVar17 = uVar17 + (iVar7 * iVar15) / iVar4;
      uVar8 = uVar13 ^ uVar17;
      while ((uVar8 & 0x8000) == 0) {
      ...
      WriteShortToBuffer(RAM, (param_1 + 0x2018), uVar18);
      WriteLongToBuffer(RAM, (param_1 + 0x2020), uVar13);
      uVar6  = (unsigned int)CharArrayToShort(RAM, param_1 + 0x212a);
      while( 1 ) {
        uVar17  = (unsigned int)CharArrayToShort(RAM, iVar20 + iVar4 * 2 + 0x100);
        if ((int)(iVar7 + uVar17) <=
            (int)(uVar6 * (((unsigned int)CharArrayToShort(RAM, param_1 + 0x2018) -
                           (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c)) + 1) + -1) /
            (int)(((unsigned int)CharArrayToShort(RAM, param_1 + 0x201a) - (unsigned int)CharArrayToShort(RAM, param_1 + 0x201c)) + 1))
      ...
      iVar10 = (CharArrayToShort(RAM, param_1 + 0x201a) - uVar11) + 1;
      uVar17 = CharArrayToLong(RAM, param_1 + 0x2020);
      uVar8 = ((int)(iVar10 * (iVar7 + (unsigned int)CharArrayToShort(RAM, iVar20 + uVar14 * 2 + 0x180))) / (int)uVar6
              + uVar11) - 1;
      uVar11 = uVar11 + (iVar10 * iVar7) / (int)uVar6;
      uVar6 = uVar8 ^ uVar11;
      while ((uVar6 & 0x8000) == 0) {
      ...
      uVar6 = iVar4 - 0x44U & ~-((unsigned int)(uVar14 < 4) - ((int)uVar14 >> 0x1f));
      iVar7 = iVar20 + uVar6 * 2;
      while( 1 ) {
        iVar10 = 0x3f;
        if (iVar4 + -0x3c < 0x3f) {
    ...
    if (uVar14 == 0xf) {
      ...
      if (0xf < (int)uVar14) {
        ...
        uVar8 = iVar4 * iVar7;
        uVar13 = (((int)uVar13 >> 4) + (unsigned int)((int)uVar13 < 0 && (uVar13 & 0xf) != 0) + uVar17) - 1;
        uVar17 = uVar17 + ((int)uVar8 >> 4) + (unsigned int)((int)uVar8 < 0 && (uVar8 & 0xf) != 0);
        uVar8 = uVar13 ^ uVar17;
        while ((uVar8 & 0x8000) == 0) {
          uVar6 = uVar6 << 1;
          uVar17 = uVar17 << 1;
...
unsigned int DecompressSK_ASC(unsigned char* compressedFile, unsigned int compressedFileSize, void ** output)
{
	unsigned char* RAM = (unsigned char*)malloc(0x1800000);// new unsigned char[0x1800000];
	for (int x = 0; x < 0x1800000; x++)
		RAM[x] = 0x00;

	// length is first 4 bytes of decompressed buffer
	int length = FUN_80146110(RAM, compressedFile, compressedFileSize - 8, 0x805EDEA0, 0x805F0980, output);
...
int main(int argc, char ** argv){
	...
	if(fread(buf+8, fileSize, 1, fh)!=1){
		exit(1);
	}

	int fileLength=DecompressSK_ASC(buf+8, fileSize, (void**)buf);

	fwrite(*((void**)buf), fileLength, 1, stdout);
	free(buf);
	return 0;
}
